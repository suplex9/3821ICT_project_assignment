...
var MapCountSchema = mongoose.Schema({}, {collection: 'climateAU'});
var MapCountSchema1 = mongoose.Schema({}, {collection: 'climateAU'});
var MapCountSchema2 = mongoose.Schema({}, {collection: 'climateAU'});
var MapCountSchema3 = mongoose.Schema({}, {collection: 'climateAU'});
var MapCountSchema4 = mongoose.Schema({}, {collection: 'climateAU'});
